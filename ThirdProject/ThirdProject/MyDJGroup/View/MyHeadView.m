...
-(instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        //登陆的用户名的视图
        _UserNameLabel = [UILabel labelWithFrame:CGRectZero backgroundColor:UIColorFromRGB(0xFF1029) text:@"马上登陆，获取更多党建咨询" textColor:UIColorFromRGB(0xF6E9E9) font:[UIFont systemFontOfSize:17.0] textAlignment:NSTextAlignmentCenter numberOfLines:1 adjustsFontSizeToFitWidth:NO];
