...
@optional
/** 监听点击的图片 */
- (void)bannerView:(SLBannerView *_Nullable)banner didClickImagesAtIndex:(NSInteger)index;
...
@property (nonatomic, weak) id <SLBannerViewDelegate> _Nullable delegate;

/** xib快速构造方法 */
+ (instancetype _Nullable )bannerViewXib;
/** 代码快速构造方法 */
+ (instancetype _Nullable )bannerView;
/**
 注：圆点页码控制，默认靠下居中
 */
@end
